...
export function Problem() {
  return (
    <section id="manifesto" className="py-24 border-b border-white/[0.06] bg-base-bg">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <motion.h2
          ...
          className="text-3xl md:text-5xl font-bold text-ink-primary font-cal mb-8 leading-tight"
        >
          Forged in the Trenches. <br className="hidden md:block" />
          <span className="text-brand-violet">Built for the Crew.</span>
        </motion.h2>
        ...
        <motion.div
          ...
          className="space-y-6 text-lg md:text-xl text-ink-secondary leading-relaxed"
        >
          <p>
